    ...
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center py-12 px-6 lg:px-8">
      ...
      <img class="mx-auto h-20 w-auto" src="/logo.png" alt="Logo" />
        ...
        <p class="mt-2 text-center text-sm text-gray-600 max-w">
          Not registered yet?
          <a href="#" class="ml-1 font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">Sign up</a>
        </p>
      </div>
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
          <form class="mb-0 space-y-6" action="#" method="POST">
            ...
            <div>
              <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0096FF] hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">Sign In</button>
            </div>
          </form>
        </div>
      </div>
